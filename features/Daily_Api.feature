...
Feature: Verify if the API returns the traded data of daily time series
  ...
  Scenario Outline: Verify TIME_SERIES_DAILY API functionality
    ...
    |TIME_SERIES_DAILY  | IBM          | compact    | IMG8W99RT7KQ5Y9V |
    |TIME_SERIES_DAILY  | TASCO.LON    | Full       | IMG8W99RT7KQ5Y9V |
    |TIME_SERIES_DAILY  | SHOP.TRT     | compact    | IMG8W99RT7KQ5Y9V |
    |TIME_SERIES_DAILY  | GVP.TRV      | compact    | IMG8W99RT7KQ5Y9V |
    |TIME_SERIES_WEEKLY | ABC          | compact    | abc              |
